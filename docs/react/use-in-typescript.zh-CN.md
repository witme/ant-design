...
如果你使用的是 npm（接下来我们都会用 yarn 作为例子，如果你习惯用 npm 也是一样的）。

```bash
$ npm install -g create-react-app
$ create-react-app antd-demots --scripts-version=react-scripts-ts
```
...
这个时候你可能会碰到下面类似的错误，这是因为 antd 的类型定义还不完善（[帮助我们完善定义](https://github.com/ant-design/ant-design/issues/5627)）。
